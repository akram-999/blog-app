        ...
        <div class="overflow-hidden bg-white rounded-md shadow-md">
            <div class="px-4 py-6 sm:px-8 sm:py-7">
                <div class="text-center">
                    ...
                    <p class="mt-2 text-base text-gray-600">Don’t have one? <a href="#" title="" class="text-orange-400 transition-all duration-200 hover:underline hover:text-orange-500">Create a free account</a></p>
                </div>
