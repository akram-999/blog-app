      ...
      <div class="min-h-screen flex fle-col items-center justify-center py-6 px-4">
        <div class="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
          <div>
            ...
            <p class="text-sm mt-6 text-gray-800">Immerse yourself in a hassle-free Register journey with our intuitively designed login form. Effortlessly access your account.</p>
            <p class="text-sm mt-12 text-gray-800">Alrady have an account <Link to="/login" class="text-orange-400 font-semibold hover:underline ml-1">Login here</Link></p>
          </div>
          ...
          <form class="max-w-md md:ml-auto w-full">
            ...
            <div class="space-y-4">
              <div>
                <input name="FullName" type="text" autocomplete="current-password" required class="bg-gray-100 w-full text-sm text-gray-800 px-4 py-3.5 rounded-md outline-blue-600 focus:bg-transparent" placeholder="Password" />
              </div>
              <div>
            ...
            <div class="!mt-8">
              <button type="button" class="w-full shadow-xl py-2.5 px-4 text-sm font-semibold rounded text-white bg-gradient-to-tr from-green-600  to-green-300 focus:outline-none">
                Register
              </button>
            </div>
